...
public class Ocupacion implements Serializable {
    ...
    @JoinColumn(name = "ocupacion", referencedColumnName = "id_terceros")
    @ManyToOne(optional = false)
    private Tercero ocupacion;
    ...
    public Tercero getOcupacion() {
        return ocupacion;
    }

    public void setOcupacion(Tercero ocupacion) {
